...
[Setup]
AppName=GNU Prolog
AppVerName=GNU Prolog version 1.4.4
AppVersion=1.4.4
...
OutputDir=
OutputBaseFileName=setup-gprolog-1.4.4-
...
[Registry]
Root: HKCU; Subkey: "Software\GnuProlog"; ValueType: string; ValueName: "Version"; ValueData: "1.4.4"
